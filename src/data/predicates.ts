...
const PREDICATE_DEFINITIONS: PredicateDefinition[] = [
  ...
  // ─── Person → Organization ────────────────────────────────
  { id: 'memberOf', label: 'memberOf', description: 'Subject is a member of organization', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: [...ORG_TYPES, 'MusicGroup'] },
  { id: 'founderOf', label: 'founderOf', description: 'Subject founded the organization', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: [...ORG_TYPES] },
  { id: 'worksAt', label: 'worksAt', description: 'Subject is employed by organization', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: [...ORG_TYPES] },
  { id: 'contributorTo', label: 'contributorTo', description: 'Subject contributes to project or org', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: [...ORG_TYPES, ...SOFTWARE_TYPES, 'Dataset'] },

  // ─── Person → Abstract ────────────────────────────────────
  { id: 'interestedIn', label: 'interestedIn', description: 'Subject has interest in concept', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: ['DefinedTerm', 'Thing'] },
  { id: 'expertIn', label: 'expertIn', description: 'Subject has deep expertise in area', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: ['DefinedTerm', 'Thing'] },
  ...
  // ─── Person → Location ────────────────────────────────────
  { id: 'locatedIn', label: 'locatedIn', description: 'Entity is located in place', subjectTypes: [...IDENTITY_ACTOR_TYPES, ...ORG_TYPES, 'Event'], objectTypes: ['Place'] },

  // ─── Person → Event ───────────────────────────────────────
  { id: 'attendedEvent', label: 'attendedEvent', description: 'Subject attended an event', subjectTypes: [...IDENTITY_ACTOR_TYPES], objectTypes: ['Event'] },
  { id: 'organizedEvent', label: 'organizedEvent', description: 'Subject organized an event', subjectTypes: [...IDENTITY_ACTOR_TYPES, ...ORG_TYPES], objectTypes: ['Event'] },

  // ─── Organization → Person ────────────────────────────────
  { id: 'employs', label: 'employs', description: 'Organization employs person', subjectTypes: [...ORG_TYPES], objectTypes: [...IDENTITY_ACTOR_TYPES] },
  { id: 'advisedBy', label: 'advisedBy', description: 'Organization is advised by person', subjectTypes: [...ORG_TYPES], objectTypes: [...IDENTITY_ACTOR_TYPES] },
  ...
  // ─── Software → * ─────────────────────────────────────────
  { id: 'createdBy', label: 'createdBy', description: 'Software was created by person or org', subjectTypes: [...SOFTWARE_TYPES], objectTypes: [...IDENTITY_ACTOR_TYPES, ...ORG_TYPES] },
  ...
  { id: 'maintainedBy', label: 'maintainedBy', description: 'Software is maintained by org or person', subjectTypes: [...SOFTWARE_TYPES], objectTypes: [...IDENTITY_ACTOR_TYPES, ...ORG_TYPES] },
  ...
  // ─── Blockchain → * ───────────────────────────────────────
  { id: 'ownedBy', label: 'ownedBy', description: 'Account or contract is owned by entity', subjectTypes: ['EthereumAccount', 'Account', 'EthereumSmartContract', 'EthereumERC20'], objectTypes: [...IDENTITY_ACTOR_TYPES, ...ORG_TYPES] },
  { id: 'controlledBy', label: 'controlledBy', description: 'Account is controlled by person', subjectTypes: ['EthereumAccount', 'Account'], objectTypes: [...IDENTITY_ACTOR_TYPES] },
  ...
  // ─── Creative Work → * ────────────────────────────────────
  { id: 'authoredBy', label: 'authoredBy', description: 'Work was authored/created by', subjectTypes: [...CREATIVE_WORK_TYPES], objectTypes: [...IDENTITY_ACTOR_TYPES] },
  { id: 'publishedBy', label: 'publishedBy', description: 'Work was published by', subjectTypes: [...CREATIVE_WORK_TYPES, 'WebSite'], objectTypes: [...ORG_TYPES, ...IDENTITY_ACTOR_TYPES] },
  ...
  // ─── Web → * ──────────────────────────────────────────────
  { id: 'hostedBy', label: 'hostedBy', description: 'Website or page hosted by org', subjectTypes: ['WebSite', 'WebPage'], objectTypes: [...ORG_TYPES, ...IDENTITY_ACTOR_TYPES] },
  ...
  // ─── Generic ──────────────────────────────────────────────
  { id: 'isA', label: 'isA', description: 'Entity is an instance of type/concept', subjectTypes: ['Thing', ...IDENTITY_ACTOR_TYPES, ...ORG_TYPES, ...SOFTWARE_TYPES, 'Product', 'Service'], objectTypes: ['DefinedTerm', 'Thing'] },
  { id: 'partOf', label: 'partOf', description: 'Entity is part of larger entity', subjectTypes: ['Thing', ...IDENTITY_ACTOR_TYPES, 'WebPage', 'MusicRecording', 'PodcastEpisode', 'Article'], objectTypes: ['Thing', ...ORG_TYPES, 'MusicAlbum', 'PodcastSeries', 'Book', 'WebSite'] },
];
